 ...
 * Generated for Laravel 6.10.1 on 2020-01-14 11:23:31.
 *
...
namespace DaveJamesMiller\Breadcrumbs\Facades { 
    ...
    class Breadcrumbs {
         ...
         * @static 
         */ 
        public static function resource($name, $title, $otherParent = null)
        {
                        return \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager::resource($name, $title, $otherParent);
        }
