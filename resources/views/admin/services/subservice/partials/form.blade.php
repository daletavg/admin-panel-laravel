...
<div class="row">
    <div class="col-md-6">
        @include('admin.layouts.partials.inputs.default-input',['name'=>'price','title'=>'Цена','type'=>'number'])
    </div>
    <div class="col-md-6">
        @include('admin.layouts.partials.inputs.default-input',['name'=>'term','title'=>'Сроки'])
    </div>
</div>
<div class="row">
    <div class="col-md-6">
