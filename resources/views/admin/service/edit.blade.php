<form method="post" action="{{route('admin.services.update',$edit)}}" enctype="multipart/form-data">
    @csrf
    @method('put')
    ...
    <ul class="nav nav-tabs mb-5" role="tablist">
        ...
        <li role="presentation"><a href="#priceTab"  role="tab"
                                   data-toggle="tab">Прайс</a></li>
    ...
    <section class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane " id="priceTab">
            <div class="panel-body">
                @include('admin.service.partials.price')
            </div>
        </div>
