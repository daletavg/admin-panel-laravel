    ...
    <div class="table-responsive">
        <table class="table table-shopping">
            ...
            <tr>
                ...
                <th>Активно</th>
                <th class="text-right">
                    <a href="{{route('admin.clients.create')}}" class="btn btn-primary">@lang('admin.create')</a>
                </th>
            </tr>
            </thead>
            <tbody data-sortable-container="true" data-table="clients">
                    ...
                    <td class="text-primary text-right">
                        <div class="dropdown menu_drop">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton_1">
                                ...
                                <form method="POST" action={{route('admin.clients.destroy',$item->id)}}
