    ...
    <div class="wrapper">
        <div class="header__container">
            <div class="header__burger d-lg-none">
                <span class="header__burger-dot"></span>
            ...
            <div class="header__logo-list d-flex align-items-center">
                <a href="{{route('home.index')}}" class="header__logo">
                    ...
                    >
                        ...
                        <g>
                            ...
                            <path
                                class="cls-1"
                                d="M153.65,40.53l-2,1.56a4.77,4.77,0,0,1-2.35,1.09.11.11,0,0,1-.12-.12c0-.11.08-.19.23-.22a6.81,6.81,0,0,0,2.4-1.32l2.65-2.11c1.45-1.19,2.56-1.78,3.34-1.78.41,0,.62.16.62.48.14,0,.21.06.21.19s-.08.16-.24.17a3.88,3.88,0,0,1-.71,1.34,1.71,1.71,0,0,1-1.21.8c-.23,0-.35-.1-.35-.31s.25-.69.75-1.17a3.89,3.89,0,0,1,1.18-.85l0-.11c0-.09-.05-.13-.14-.13-.41,0-1.17.57-2.27,1.7S154,41.67,154,42.12a.61.61,0,0,0,.37.6,2.59,2.59,0,0,0,.68.13c.25,0,.37.08.37.16s-.22.2-.67.2c-1,0-1.49-.45-1.49-1.35A3.24,3.24,0,0,1,153.65,40.53Zm4.25-1.82a3,3,0,0,0-.78.62c-.37.35-.55.6-.55.74l.08.07c.17,0,.41-.19.71-.58A4.38,4.38,0,0,0,157.9,38.71Z"
                            />
                            <path
                                class="cls-1"
                                d="M162.72,42.88l.6,0c.08,0,.13,0,.13.15s-.15.19-.45.22l-.6,0-2.65,3.28q-2.38,2.73-3.39,2.73c-.31,0-.47-.22-.47-.64,0-1,.62-2.05,1.87-3.29A8.07,8.07,0,0,1,161.6,43l2-2.53L162,41.89a4.59,4.59,0,0,1-1.94,1.18c-.4,0-.6-.29-.6-.85a3.16,3.16,0,0,1,.69-1.72L161.33,39q-1.12,1-2.58,2.16c-.79.63-1.33,1-1.61,1.22a3.71,3.71,0,0,1-1.86.77c-.08,0-.12,0-.12-.13a.21.21,0,0,1,.19-.21,9.79,9.79,0,0,0,3.32-2l1.66-1.36,1.08-1a4.66,4.66,0,0,1,1-.78.78.78,0,0,1,.47.16.49.49,0,0,1,.22.41L161.62,40a5.8,5.8,0,0,0-1.51,2.38c0,.11.07.17.19.17.38,0,1.32-.7,2.79-2.12,1.09-1,2-2,2.71-2.77.14-.17.25-.25.31-.25a.67.67,0,0,1,.38.13.34.34,0,0,1,.19.3.39.39,0,0,1-.12.23A51.53,51.53,0,0,0,162.72,42.88Zm-1.45.57a8.19,8.19,0,0,0-3.47,2.26,4.52,4.52,0,0,0-1.56,2.7c0,.21.07.32.23.32Q157.39,48.73,161.27,43.45Z"
                            />
                        </g>
                        <path
                            class="cls-1 header__burger-image-dot"
                            d="M117.67,7.71a3.56,3.56,0,0,0,2.62-1.09A3.63,3.63,0,0,0,121.38,4a3.59,3.59,0,0,0-1.09-2.63,3.71,3.71,0,0,0-5.25,0A3.56,3.56,0,0,0,114,4,3.59,3.59,0,0,0,115,6.62,3.56,3.56,0,0,0,117.67,7.71Z"
                        />
                        <path
                            class="cls-2"
                            d="M120.94,29.55V11.32h-9.21v1.15a3.58,3.58,0,0,1,2,.79,3,3,0,0,1,.49,2V29.37a3,3,0,0,1-.7,2.27,3.6,3.6,0,0,1-1.74.63v1.15h11.44V32.27a3.63,3.63,0,0,1-1.76-.7A3,3,0,0,1,120.94,29.55Z"
                        />
                    </svg>
                </a>
                <div class="header__list d-none d-lg-flex">
                    <a href="{{route('home.index')}}" class="header__link">{{getTranslate('posters.global')}}</a>
                    <a href="{{route('about.index')}}" class="header__link">{{getTranslate('about_company.global')}}</a>
                    <a href="{{route('services.index')}}" class="header__link">{{getTranslate('our_services.global')}}</a>
                    <a href="{{route('history.index')}}" class="header__link">{{getTranslate('history_events.global')}}</a>
                    <a href="{{route('partners.index')}}" class="header__link">{{getTranslate('partners.global')}}</a>
                </div>
            </div>
                ...
                >
                    <div class="search-field">
                        <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <g id="Symbols" stroke="none" stroke-width="1"  fill-rule="evenodd">
                                <g id="head" transform="translate(-1312.000000, -25.000000)"  fill-rule="nonzero">
                                    <path d="M1317.96982,35.0740741 C1318.71605,35.0740741 1319.40375,34.887519 1320.03292,34.5144033 C1320.6621,34.1412876 1321.15958,33.6401495 1321.52538,33.0109739 C1321.89118,32.3817984 1322.07407,31.6941052 1322.07407,30.9478738 C1322.07407,30.2016424 1321.89118,29.5139492 1321.52538,28.8847737 C1321.15958,28.2555981 1320.6621,27.758118 1320.03292,27.3923182 C1319.40375,27.0265185 1318.71605,26.8436214 1317.96982,26.8436214 C1317.22359,26.8436214 1316.5359,27.0265185 1315.90672,27.3923182 C1315.27755,27.758118 1314.77641,28.2555981 1314.40329,28.8847737 C1314.03018,29.5139492 1313.84362,30.2016424 1313.84362,30.9478738 C1313.84362,31.6941052 1314.03018,32.3817984 1314.40329,33.0109739 C1314.77641,33.6401495 1315.27755,34.1412876 1315.90672,34.5144033 C1316.5359,34.887519 1317.22359,35.0740741 1317.96982,35.0740741 Z M1323.45679,35.0740741 L1328,39.617284 L1326.61728,41 L1322.07407,36.4348422 L1322.07407,35.7105624 L1321.8107,35.4691358 C1321.29858,35.9227275 1320.70965,36.270232 1320.0439,36.5116598 C1319.37814,36.7530876 1318.68679,36.8737997 1317.96982,36.8737997 C1316.88705,36.8737997 1315.88844,36.6104279 1314.97394,36.0836763 C1314.05944,35.5569247 1313.33882,34.8472838 1312.81207,33.9547325 C1312.27069,33.0329172 1312,32.030641 1312,30.9478738 C1312,29.8651066 1312.26703,28.8664883 1312.8011,27.951989 C1313.33516,27.0374897 1314.05944,26.3168724 1314.97394,25.7901235 C1315.88844,25.2633719 1316.88705,25 1317.96982,25 C1319.05259,25 1320.05487,25.2706877 1320.97668,25.8120713 C1321.86923,26.3388229 1322.57521,27.0557796 1323.09465,27.962963 C1323.61409,28.8701463 1323.8738,29.8651066 1323.8738,30.9478738 C1323.8738,31.6794733 1323.75309,32.3781402 1323.51166,33.0438957 C1323.27023,33.7096512 1322.92273,34.29858 1322.46914,34.8106996 L1322.71056,35.0740741 L1323.45679,35.0740741 Z" id=""></path>
                                </g>
                            </g>
                        </svg>
                    ...
                    <div class="header__search__input" data-submit="url">
                        ...
                        <div class="header__search__list">
                            <!-- <div class="header__search__list-overlay"></div> -->
                            <div class="header__search__list-box"></div>
                            <!-- <div class="header__search__list-item">
                                <img src="img/oskar_2019.jpg" alt="" class="search__image">
                                <div class="search_container">
                                  <p class="search_container__text">13 октября 19:00</p>
                                  <p class="search_container__title">МЕЛОДИИ СЕРДЦА ЭДВАРДА ГРИГА</p>
                                  <p class="search_container__text">Одесса, Театр Оперы и
                                    Балета</p>
                                  <a href="event.html" class="search_container__btn align-self-end">
                                    <span>Подробнее</span>
